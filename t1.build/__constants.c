...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    Nuitka_SysSetObject(
        ...
        global_constants[89]
#else
        getStandaloneSysExecutablePath(global_constants[89])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 1, PyInt_FromLong(8));
