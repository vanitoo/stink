...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("multiprocessing-postLoad"));
...
static PyObject *impl_multiprocessing$$45$postLoad$$$function__2__reduce_compiled_method(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_36a26664e71f2c01c03d238acecf75a3 = MAKE_FUNCTION_FRAME(tstate, codeobj_36a26664e71f2c01c03d238acecf75a3, module_multiprocessing$$45$postLoad, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_36a26664e71f2c01c03d238acecf75a3);
    ...
    branch_yes_1:;
    {
        ...
        tmp_return_value = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_2 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_2, mod_consts[2]);
    ...
    branch_no_1:;
    {
        ...
        tmp_return_value = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_4 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_5, mod_consts[0]);
...
PyObject *modulecode_multiprocessing$$45$postLoad(PyThreadState *tstate, PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_74e94b18c155cd8898f2d19b6a56845f);
    ...
    }
    {
        ...
        tmp_type_arg_1 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_2, mod_consts[20]);
